  ...
  return (
    <section className="relative overflow-hidden">
      ...
      >
        ...
        <div className="relative mx-auto flex max-w-6xl flex-col justify-center gap-8 px-4 py-20 md:flex-row md:items-center md:gap-12 md:px-6 md:py-28">
          ...
          <div className="flex w-full justify-center md:w-1/2 md:justify-end">
            <div className="hero-logo-wrap relative h-[12rem] w-[12rem] opacity-95 sm:h-[16rem] sm:w-[16rem] md:h-[22rem] md:w-[22rem] lg:h-[32rem] lg:w-[32rem]">
              <Image
